...
namespace Project1
{
    public partial class ShowDetails : System.Web.UI.Page
    {
        ...
        {
            string sel = "select Pro_Id,Name,Price,Image,Stock from ProductTab";
            DataSet ds = obj.Fn_ds(sel);
        ...
        protected void GridView2_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            TextBox txtstock = (TextBox)GridView2.Rows[i].Cells[4].Controls[0];

            string up = "update ProductTab set Name='" + txtname.Text + "',Price=" + txtprice.Text + ",Stock="+txtstock+" where Pro_Id=" + usrid + "";
            int b = obj.Fn_nq(up);
